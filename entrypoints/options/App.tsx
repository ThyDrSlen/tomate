        ...
        <div class="space-y-4">
          <label class="block">
            ...
            <input
              ...
              class="mt-1 block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500"
            />
          </label>
          ...
          <label class="flex items-center gap-3 cursor-pointer">
            <input
              ...
              class="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-red-600 focus:ring-red-500"
            />
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Play completion sound</span>
          </label>
        </div>
